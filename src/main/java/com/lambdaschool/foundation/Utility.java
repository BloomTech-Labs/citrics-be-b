...
public final class Utility {
    ...
    public static Integer optionallyReplace(
            Integer original, JsonNode newData, String fieldName) {
        // if newData doesn't have field, return original
        if (!newData.has(fieldName))
            return original;
    ...
    public static Double optionallyReplace(
            Double original, JsonNode newData, String fieldName) {
        // if newData doesn't have field, return original
        if (!newData.has(fieldName))
            return original;
    ...
    public static String optionallyReplace(
            String original, JsonNode newData, String fieldName) {
        // if newData doesn't have field, return original
        if (!newData.has(fieldName))
            return original;
